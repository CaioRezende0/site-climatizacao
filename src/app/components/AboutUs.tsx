export default function AboutUs() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-16">
      {/* TÍTULO */}
      <p className="text-xl font-medium text-orange-500 mb-2">Sobre nós</p>
      <h2 className="text-3xl sm:text-5xl font-bold text-gray-800 leading-tight max-w-3xl">
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10 items-start">
        ...
        <div className="flex-1">
          <div className="w-full h-64 sm:h-80 bg-gray-300 rounded-2xl transition-transform duration-300 hover:scale-105" />
        </div>
